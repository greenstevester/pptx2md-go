...
- [ ] Push the engine repo to `github.com/greenstevester/powerpoint-to-md-skill-go`
...
- [ ] Consider a root-level `.claude-plugin/marketplace.json` (or a release asset)
      so the GitHub-shorthand `/plugin marketplace add greenstevester/powerpoint-to-md-skill-go`
...
- [ ] Mirror as a standalone `powerpoint-to-md-skill` repo if the two-repo split
